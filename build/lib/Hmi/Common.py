...
import Hmi.AlarmWindow
import Hmi.AlarmAnalogWindow
import Hmi.ProcessValueWindow
import Hmi.PointEnumerationWindow
import Hmi.PointAnalogWindow
import Hmi.PointDiscreteWindow
...
def hmi_interact(o) -> None:
    ...
    if o.hmi_object_name == "AlarmWindow":
        win = Hmi.AlarmWindow.AlarmWindow(o)
        win.hmi_get_user_input()
    elif o.hmi_object_name == "AlarmAnalogWindow":
        win = Hmi.AlarmAnalogWindow.AlarmAnalogWindow(o)
        win.hmi_get_user_input()
    elif o.hmi_object_name == "ProcessValueWindow":
        win = Hmi.ProcessValueWindow.ProcessValueWindow(o)
        win.hmi_get_user_input()
    elif o.hmi_object_name == "PointAnalogWindow":
        win = Hmi.PointAnalogWindow.PointAnalogWindow(o)
        win.hmi_get_user_input()
    elif o.hmi_object_name == "PointDiscreteWindow":
        win = Hmi.PointDiscreteWindow.PointDiscreteWindow(o)
        win.hmi_get_user_input()
    elif o.hmi_object_name == "PointEnumerationWindow":
        win = Hmi.PointEnumerationWindow.PointEnumerationWindow(o)
        win.hmi_get_user_input()

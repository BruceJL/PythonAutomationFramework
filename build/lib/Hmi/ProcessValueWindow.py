...
class ProcessValueWindow(AbstractWindow):
    ...
    def hmi_window_size(self) -> [int, int, int]:
        ...
        x = x1 + x2
        if x < len(self.p.point.description):
    ...
    def hmi_draw_window(self):
        ...
        i = round(x / 2 - len(self.p.point.description) / 2)
        j = 2

        self.screen.addstr(j, i, self.p.point.description, curses.A_BOLD)
        ...
        Hmi.Common.draw_property(
          ...
          str(self.p.point.human_readable_value),
          Hmi.Common.get_point_curses_color(self.p.point))
        ...
        if 0 < len(self.p.control_points):
            ...
            for key in self.p.control_points:
                ...
                Hmi.Common.draw_property(
                  ...
                  Hmi.Common.get_point_curses_color(cp)
                )
        ...
        if 0 < len(self.p.related_points):
            ...
            for key in self.p.related_points:
                ...
                Hmi.Common.draw_property(
                  ...
                  Hmi.Common.get_point_curses_color(rp))
                j += 1
                index += 1
        ...
        if 0 < len(self.p.alarms):
            ...
            for key in self.p.alarms:
                ...
                Hmi.Common.draw_property(
                  ...
                  Hmi.Common.get_alarm_curses_color(a))
                j += 1
                index += 1

...
class TestAnalogAlarmAnalog(unittest.TestCase):
    ...
    def test_a_json_pickle(self):
        ...
        self.assertEqual(self.alarm.high_low_limit, unpickled_alarm.high_low_limit)

        # make sure all inherited properties line up.
        self.assertEqual(self.alarm.name, unpickled_alarm.name)
        self.assertEqual(self.alarm.description, unpickled_alarm.description)
        self.assertEqual(self.alarm.blocked, unpickled_alarm.blocked)
        self.assertEqual(self.alarm.acknowledged, unpickled_alarm.acknowledged)
        self.assertEqual(self.alarm.enabled, unpickled_alarm.enabled)
        ...
        self.assertEqual(self.alarm.state, unpickled_alarm.state)
        ...
        self.assertEqual(self.alarm._activation_time, unpickled_alarm._activation_time)
        self.assertEqual(self.alarm._is_reset_time, unpickled_alarm._is_reset_time)
